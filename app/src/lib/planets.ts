...
export const PLANETS: PlanetDef[] = [
  ...
  // Main-belt bodies. Scene radius is the JPL mean radius divided by Earth's
  // 6,371 km, the same ratio the planets above use.
  {
    id: 'vesta',
    name: 'Vesta',
    emoji: '🪨',
    radius: 0.041,
    segments: 48,
    semiMajorAxisAu: 2.36136597,
    orbitPeriodDays: 1325.389,
    ...
    atmosphereIntensity: 0,
    knownMoonCount: 0,
    surfaceTint: [0.74, 0.71, 0.66],
    uiColor: 'border-amber-200/50 bg-amber-200/10 text-amber-100',
    uiGlow: '',
  },
  {
    id: 'pallas',
    ...
    radius: 0.0403,
    segments: 48,
    semiMajorAxisAu: 2.76955901,
    orbitPeriodDays: 1683.505,
  ...
  },
  {
    ...
    radius: 0.0319,
    segments: 48,
    semiMajorAxisAu: 3.15097403,
    orbitPeriodDays: 2042.987,
    rotationPeriodHours: 13.828,
    axialTilt: 0,
    inclination: 3.83,
    atmosphereColor: null,
    atmosphereIntensity: 0,
    knownMoonCount: 0,
    surfaceTint: [0.42, 0.42, 0.44],
    uiColor: 'border-slate-400/50 bg-slate-400/10 text-slate-200',
    uiGlow: '',
  },
  {
    id: 'juno',
    ...
    radius: 0.0194,
    segments: 48,
    semiMajorAxisAu: 2.67098953,
    orbitPeriodDays: 1594.435,
    ...
    atmosphereIntensity: 0,
    knownMoonCount: 0,
    surfaceTint: [0.68, 0.62, 0.54],
    uiColor: 'border-orange-200/50 bg-orange-200/10 text-orange-100',
    uiGlow: '',
  },
  {
    id: 'psyche',
    ...
    atmosphereIntensity: 0,
    knownMoonCount: 0,
    surfaceTint: [0.60, 0.58, 0.55],
    uiColor: 'border-zinc-400/50 bg-zinc-400/10 text-zinc-100',
    uiGlow: '',
  },
  // Trans-Neptunian bodies. JPL publishes no diameter for these three, so the
  // scene radius comes from the occultation and thermal measurements cited in
  // celestial-facts.ts.
  {
    id: 'quaoar',
    name: 'Quaoar',
    ...
    radius: 0.0871,
    segments: 48,
    semiMajorAxisAu: 43.15617649,
    orbitPeriodDays: 103553.04,
    ...
    atmosphereIntensity: 0,
    knownMoonCount: 1,
    surfaceTint: [0.70, 0.58, 0.52],
    uiColor: 'border-rose-200/50 bg-rose-200/10 text-rose-100',
    uiGlow: '',
  },
  {
    id: 'gonggong',
    ...
    radius: 0.0961,
    segments: 48,
    semiMajorAxisAu: 66.8666119,
    orbitPeriodDays: 199715.79,
    ...
    atmosphereIntensity: 0,
    knownMoonCount: 1,
    surfaceTint: [0.74, 0.48, 0.40],
    uiColor: 'border-red-300/50 bg-red-300/10 text-red-100',
    uiGlow: '',
  },
  {
    id: 'sedna',
    ...
    radius: 0.0781,
    segments: 48,
    semiMajorAxisAu: 543.71952891,
    orbitPeriodDays: 4630851.18,
    ...
    atmosphereIntensity: 0,
    knownMoonCount: 0,
    surfaceTint: [0.80, 0.44, 0.34],
    uiColor: 'border-rose-300/50 bg-rose-300/10 text-rose-100',
    uiGlow: '',
  },
]
